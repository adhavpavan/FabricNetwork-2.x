createcertificatesForOrg1() {
  ...
  echo
  fabric-ca-client reenroll -u https://peer0:peer0pw@localhost:7054 --caname ca.org1.example.com -M ${PWD}/../crypto-config_1/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/msp --csr.hosts peer0.org1.example.com   --csr.keyrequest.reusekey --tls.certfiles ${PWD}/fabric-ca/org1/tls-cert.pem
...
createCertificatesForOrg2() {
  ...
  fabric-ca-client reenroll -u https://admin:adminpw@localhost:8054 --caname ca.org2.example.com --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem --csr.keyrequest.reusekey --tls.certfiles ${PWD}/fabric-ca/org1/tls-cert.pem
